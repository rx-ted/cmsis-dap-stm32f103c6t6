...
- Verified end-to-end against a Blue Pill (STM32F103C8T6): CPUID
  0x411FC231, target reset, halt/resume, memory reads.
...
- **SWO / ITM trace**: the C6 board does not populate TDO/SWO (JTAG and
  trace removed from this variant). SWD only.
- **JTAG**: TDI/TDO are not wired; the DAP_Info caps reflect SWD only.
